...
describe('ConfirmModal', () => {
  it('does not confirm when cancelled', async () => {
    ...
    render(
      providers(
        <ConfirmModal opened title="delete folder" onConfirm={onConfirm} onClose={onClose}>
          Delete &quot;tech&quot;?
        </ConfirmModal>,
      ),
    );
  ...
  it('disables the confirm button while a destructive action is in flight', () => {
    render(
      providers(
        <ConfirmModal opened title="delete" loading onConfirm={() => {}} onClose={() => {}}>
          Go?
        </ConfirmModal>,
      ),
    );
  ...
  it('renders nothing meaningful content when closed', () => {
    render(
      providers(
        <ConfirmModal opened={false} title="delete" onConfirm={() => {}} onClose={() => {}}>
          hidden
        </ConfirmModal>,
      ),
    );
